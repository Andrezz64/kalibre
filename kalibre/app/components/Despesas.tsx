...
const handleCloseModal = () => setOpenModal(false);
  ...
  const Delete = () => {
    ...
    fetch(
      "http://192.168.0.112:5014/api/v1/despesas/" + props.despesaId,
      options
    )
  ...
  return (
    <div className="bg-stone-200 max-w-[14rem] max-h-[10rem] p-2 rounded-lg shadow-lg">
      ...
      <h2>
        Valor:{" "}
        <span className="text-green-500">R${props.valor.toString()}</span>
      </h2>
        ...
        >
          <Box sx={style}>
            ...
            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
              <DespesaEditForm despesaid={props.despesaId} valor={props.valor} data={props.data}></DespesaEditForm>
            </Typography>
          </Box>
        </Modal>
      </div>
